...
Modified slightly by Kyle Bradley, April 2021 to avoid a few minor issues
running under Python 3.6 / OSX Catalina
...
""" KEB: Turn off some warnings based on 0, NaN values """
...
def _ts(dt):
    ...
    KEB: Day, month changed from 01, 01 to 1, 1 to avoid Python error
    """
    return (dt-datetime.datetime(1970, 1, 1, 00, 00, 00)).total_seconds()
...
class BPFunction(object):
    ...
    M : magnitude of the parent event
