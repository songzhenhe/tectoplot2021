...
c
      ...
      integer infmt, IY1, IY2
      data infmt,IY1, IY2 /5, 0, 99/
...
c      read (5,2) catalog
c    2 format (a)
c   20 catalog='to_decluster.txt'
c   20 write (6,1)
c    1 format ('Using catalog to_decluster.txt')

C-- DECLARE THE DATA FORMAT
c        write (6, 3)
c    3   format (' Data format for input file '/
c     1  '(1=HYPOINV, 2=HYPOINV-2000, 3=HYPO71, 4=HYPO71-2000, 5=FREE):')
c        read (5, *) infmt

C-- SPECIFY STARTING AND ENDING DATES TO PROCESS
c      write (6, 52)
c   52 format (' Enter EARLIEST and LATEST YEAR to be accepted: ')
c      read (5, *) IY1, IY2

C-- SPECIFY MINIMUM MAGNITUDE TO ACCEPT
c      write (6, 50)
c   50 format (' Enter MINIMUM MAGNITUDE to be accepted: ')
c      read (5, *) xmagcut

C-- SPECIFY KEY PARAMETERS
c      write (6, 51)
c   51 format (' Enter RFACT value (default=10): ')
c      read (5, *) rfact
